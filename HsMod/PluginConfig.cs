...
namespace HsMod
{
    public static class PluginConfig
    {
        ...
        public static ConfigEntry<KeyboardShortcut> keyBulkDisenchant;
        ...
        public static void ConfigBind(ConfigFile config)
        {
            ...
            keySimulateDisconnect = config.Bind(LocalizationManager.GetLangValue("keySimulateDisconnect.label"), LocalizationManager.GetLangValue("keySimulateDisconnect.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keySimulateDisconnect.description"));
            keyCopyBattleTag = config.Bind(LocalizationManager.GetLangValue("keyCopyBattleTag.label"), LocalizationManager.GetLangValue("keyCopyBattleTag.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyCopyBattleTag.description"));
            keyCopySelectBattleTag = config.Bind(LocalizationManager.GetLangValue("keyCopySelectBattleTag.label"), LocalizationManager.GetLangValue("keyCopySelectBattleTag.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyCopySelectBattleTag.description"));
            keyConcede = config.Bind(LocalizationManager.GetLangValue("keyConcede.label"), LocalizationManager.GetLangValue("keyConcede.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyConcede.description"));
            keyContinueMulligan = config.Bind(LocalizationManager.GetLangValue("keyContinueMulligan.label"), LocalizationManager.GetLangValue("keyContinueMulligan.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyContinueMulligan.description"));
            keySquelch = config.Bind(LocalizationManager.GetLangValue("keySquelch.label"), LocalizationManager.GetLangValue("keySquelch.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keySquelch.description"));
            keySoundMute = config.Bind(LocalizationManager.GetLangValue("keySoundMute.label"), LocalizationManager.GetLangValue("keySoundMute.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keySoundMute.description"));
            keyShutUpBob = config.Bind(LocalizationManager.GetLangValue("keyShutUpBob.label"), LocalizationManager.GetLangValue("keyShutUpBob.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyShutUpBob.description"));
            keyRefund = config.Bind(LocalizationManager.GetLangValue("keyRefund.label"), LocalizationManager.GetLangValue("keyRefund.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyRefund.description"));
            keyZeroDollarShopping = config.Bind(LocalizationManager.GetLangValue("keyZeroDollarShopping.label"), LocalizationManager.GetLangValue("keyZeroDollarShopping.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyZeroDollarShopping.description"));
            ...
            keyReadNewCards = config.Bind(LocalizationManager.GetLangValue("keyReadNewCards.label"), LocalizationManager.GetLangValue("keyReadNewCards.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyReadNewCards.description"));
            ...
            keyBulkDisenchant = config.Bind("Shortcut", "Bulk Disenchant (Non-Premium)", new KeyboardShortcut(KeyCode.D, KeyCode.LeftControl), "Bulk disenchant ALL normal-quality cards in your collection; SKIPS Golden, Diamond, and Signature copies. Only fires on the Collection screen. Default Left Ctrl+D.");

            keyEmoteGreetings = config.Bind(LocalizationManager.GetLangValue("keyEmoteGreetings.label"), LocalizationManager.GetLangValue("keyEmoteGreetings.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyEmoteGreetings.description"));
            keyEmoteWellPlayed = config.Bind(LocalizationManager.GetLangValue("keyEmoteWellPlayed.label"), LocalizationManager.GetLangValue("keyEmoteWellPlayed.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyEmoteWellPlayed.description"));
            keyEmoteThanks = config.Bind(LocalizationManager.GetLangValue("keyEmoteThanks.label"), LocalizationManager.GetLangValue("keyEmoteThanks.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyEmoteThanks.description"));
            keyEmoteWow = config.Bind(LocalizationManager.GetLangValue("keyEmoteWow.label"), LocalizationManager.GetLangValue("keyEmoteWow.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyEmoteWow.description"));
            keyEmoteOops = config.Bind(LocalizationManager.GetLangValue("keyEmoteOops.label"), LocalizationManager.GetLangValue("keyEmoteOops.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyEmoteOops.description"));
            keyEmoteThreaten = config.Bind(LocalizationManager.GetLangValue("keyEmoteThreaten.label"), LocalizationManager.GetLangValue("keyEmoteThreaten.name"), new KeyboardShortcut(KeyCode.None), LocalizationManager.GetLangValue("keyEmoteThreaten.description"));
